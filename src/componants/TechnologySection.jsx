const TechnologySection = () => {
  return (
    <section id="technology" className="min-h-screen py-10">
      <div id="tech_stack ">
        <section
          id="tech_stack"
        ...
        text-lg font-medium px-4 py-2 uppercase"
              ...
              <p className="text-1xl sm:text-2xl lg:text-3xl mt-5 lg:mt-10 tracking-wide">
                {" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 backdrop-blur-sm">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white ml-4">Android</h3>
                </div>
                <div className="space-y-4">
                  <div className="group flex items-center justify-between p-4 rounded-xl border border-neutral-800 hover:border-green-500/50 transition-colors duration-300">
              ...
              <div className="p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 backdrop-blur-sm">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white ml-4">iOS</h3>
                </div>
                <div className="space-y-4">
