        ...
        <div className="container px-4 mx-auto relative text-sm">
            <div className="flex justify-between items-center">
                <div className="flex items-center flex-shrink-0">
                    <img className="h-10 w-10 mr-2" src={log} alt="" />
                    <span className="text-xl tracking-tight">TheCodeMiners</span>
                </div>
                ...
                <div className="fixed right-0 z-20 bg-neutral-900 w-full p-12 flex flex-col justify-center item-center lg:hidden">
                    <ul>{navItems.map((item,index)=>(
                        ...
                        {/* <div className="flex space-x-6">
                            ...
                            <a href="#" className="py-2 px-3 rounded-md bg-gradient-to-r  from-orange-500 to bg-orange-800">
                                Create an account
                            </a>
                       </div> */}
