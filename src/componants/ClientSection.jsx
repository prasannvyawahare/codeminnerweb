const ClientSection = () => {
  return (
    <section id="client_stories" className="min-h-screen py-10">
      <div id="root">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="relative p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 backdrop-blur-sm hover:border-indigo-500/50 transition-colors duration-300">
                ...
                <div className="flex flex-col">
                  <p className="text-neutral-300 mb-6">
                    ...
                    transform our digital presence. The team delivered beyond
                    our expectations."
                  </p>
                  <div className="mt-auto flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-indigo-400">Print Hub</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 backdrop-blur-sm hover:border-purple-500/50 transition-colors duration-300">
                ...
                <div className="flex flex-col">
                  <p className="text-neutral-300 mb-6">
                    "The mobile app they developed for us has received
                    outstanding user feedback. Their attention to detail and
              ...
              <div className="relative p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 backdrop-blur-sm hover:border-blue-500/50 transition-colors duration-300">
                ...
                <div className="flex flex-col">
                  <p className="text-neutral-300 mb-6">
                    "Their seamless collaboration and outstanding performance
                  ...
                  <div className="mt-auto flex items-center">
                    ...
                    <div className="ml-4">
                      <h4 className="text-white font-semibold">Aditya Kumar</h4>
                      <p className="text-blue-400">CEO, Open AI</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 backdrop-blur-sm hover:border-blue-500/50 transition-colors duration-300">
                ...
                <div className="flex flex-col">
                  <p className="text-neutral-300 mb-6">
                    "From start to finish, the experience was seamless. We'll
                    definitely return!"
                  </p>
                  <div className="mt-auto flex items-center">
                    <div className="w-12 h-12 rounded-full overflow-hidden">
                    ...
                    <div className="ml-4">
                      <h4 className="text-white font-semibold">Rahul </h4>
                      <p className="text-blue-400">Founder, Microtron</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 backdrop-blur-sm hover:border-blue-500/50 transition-colors duration-300">
                ...
                <div className="flex flex-col">
                  <p className="text-neutral-300 mb-6">
                    "Their service exceeded our expectations — fast, reliable,
                    and top-quality results every time!"
                  </p>
                  <div className="mt-auto flex items-center">
                    <div className="w-12 h-12 rounded-full overflow-hidden">
                      <img
