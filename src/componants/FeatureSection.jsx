      ...
      <div className="relative mt-20 border-b border-neutral-800 min-h-[800px] mb-10">
        ...
        text-lg font-medium px-4 py-2 uppercase"
          ...
          <h2 className="text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mt-20 tracking-wide">
            Easily build
            <span
              className="bg-gradient-to-r from-orange-500 to-orange-800 text-transparent
            bg-clip-text"
            >
              {" "}
              your code
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="group p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 hover:bg-neutral-800/50 transition-all duration-300">
                ...
                <p className="text-neutral-400 mb-4">
                  Tailored solutions designed to meet your specific business
              ...
              <div className="group p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 hover:bg-neutral-800/50 transition-all duration-300">
                ...
                <p className="text-neutral-400 mb-4">
                  Scalable and responsive web applications built with modern
                  technologies.
                </p>
                <a
                  href="#"
              ...
              <div className="group p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 hover:bg-neutral-800/50 transition-all duration-300">
                ...
                <p className="text-neutral-400 mb-4">
                  Secure and scalable cloud infrastructure and deployment
                  solutions.
                </p>
                <a
                  href="#"
              ...
              <div className="group p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 hover:bg-neutral-800/50 transition-all duration-300">
                ...
                <p className="text-neutral-400 mb-4">
                  Intelligent solutions powered by advanced AI and machine
                  learning algorithms.
                </p>
                <a
                  href="#"
              ...
              <div className="group p-8 rounded-2xl border border-neutral-800 bg-neutral-900/50 hover:bg-neutral-800/50 transition-all duration-300">
                ...
                <p className="text-neutral-400 mb-4">
                  Streamlined development operations and robust security
                  implementations.
                </p>
                <a
                  href="#"
