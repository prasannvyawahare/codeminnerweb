...
const TeamSection = () => {
  return (
    <div id="team">
  <section id="team_expertise" className="relative py-24 bg-neutral-900">
    {/* Background Elements */}
    <div className="absolute inset-0 bg-gradient-to-b rounded-5xl from-neutral-800 via-neutral-900/95 to-neutral-900" />
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <span className="bg-neutral-900 text-orange-500 rounded-full h-6 *
        ...
        <p className="text-neutral-400 max-w-2xl mx-auto">
          Talented professionals dedicated to delivering exceptional solutions
        </p>
      </div>
      {/* Team Grid */}
      ...
      <div className="mt-16 text-center">
        <a
          href="#careers"
          className="inline-flex items-center px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full font-medium transition-colors duration-300"
        >
          Join Our Team
          <svg
